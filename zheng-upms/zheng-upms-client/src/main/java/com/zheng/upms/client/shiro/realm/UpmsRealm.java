...
public class UpmsRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        ...
        simpleAuthorizationInfo.setStringPermissions(permissions);// 保存当前用户所有的权限。permissions值的类型upms:role:read
        simpleAuthorizationInfo.setRoles(roles); // 设置当前用户所有的角色
        return simpleAuthorizationInfo;// 可通过Subject 取出所有的权限以及对应的角色等。
    }
